...
function buildSystemPrompt(context) {
  ...
  var regleLecture = "\n\n=== REGLE ABSOLUE — LECTURE INTEGRALE DU BAIL ===\n"
    ...
    + "   - solidarite entre colocataires : la clause de solidarite est LEGALE et courante ; ne la signale\n"
    + "     JAMAIS comme illegale en soi. Statut 'danger' UNIQUEMENT si elle maintient la solidarite d'un\n"
    + "     colocataire sortant au-dela de la limite legale : clause 'illimitee', 'jusqu'a la fin du bail'\n"
    + "     apres le depart, ou qui ecarte la fin de solidarite 6 mois apres l'effet du conge (ou le\n"
    + "     remplacement par un nouveau colocataire au bail), art. 8-1 loi 1989. Une clause de solidarite\n"
    + "     standard = statut 'ok' (tu peux rappeler la regle des 6 mois a titre informatif, sans alarmer).\n"
    + "     Entre epoux ou partenaires PACS au moment de la signature, ce n'est pas une colocation : l'art.\n"
    + "     8-1 ne s'applique pas, n'invente pas d'abus de solidarite.\n"
...
function buildBailPrompt(context, extraDocs) {
  ...
  var lectureRappel = hasBail
    ? "\n\n⚠️ INSTRUCTION CRITIQUE — BAIL ATTACHE ⚠️\n"
      ...
      + "interdiction animaux, solidarite ILLIMITEE (au-dela de 6 mois apres depart d'un colocataire ; la clause de solidarite standard reste legale), travaux locataire, visites abusives, assurance imposee, etc.).\n"
